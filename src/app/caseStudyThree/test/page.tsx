  ...
  return (
    <div>
     ...
     <section className="container text-center py-5">
        <h2 className="mb-5 mt-5">Introduction to the Test Section Phase</h2>
        ...
        <div className="row justify-content-center mt-5 pb-5">
            ...
            text="Plan a usability study: Detailed documentation and analysis of
...
<ImageAndTextCard
            ...
            text="Conduct a usability study: Visual representations
...
<ImageAndTextCard
            ...
            text="Synthesize Results and modify designs: Fictional characters created based on user research to represent different user types who might use a product or service."
          />
        </div>
        <div className='pt-5'>
